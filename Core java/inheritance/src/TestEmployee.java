...
Employee e1=new Employee(102,"sakshi",35000);
e1.display();
Employee e2=new Employee();
e2.display();

SalesManager sm1=new SalesManager(1,"nagesh",80000,3000,40);
sm1.display();
SalesManager sm2=new SalesManager();
sm2.display();

SalesArea sa1=new SalesArea(2,"maruti",70000,3456,5,"mumbai");
sa1.display();
SalesArea sa2=new SalesArea();
sa2.display();

HR hr1=new HR(3,"kavita",70000,450);
hr1.display();
HR hr2=new HR();
hr2.display();


Admin a1=new Admin(4,"indumati",50000,789);
a1.display();
Admin a2=new Admin();
a2.display();
